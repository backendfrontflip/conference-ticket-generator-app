  ...
  return (
    <div className="p-4 mx-auto min-h-screen flex flex-col items-center justify-center">
      ...
      <div className="w-full max-w-md">
        <div className="ticket-container p-6 shadow-md relative bg-[url('/assets/images/pattern-ticket.svg')] bg-cover bg-center rounded-md flex flex-col justify-between">
          <div>
            ...
            <p className="date text-gray-500 mt-2 flex items-start pb-5">
      ...
      <div className="mt-5 w-full text-center font-bold p-4 bg-orange-600 border rounded-full max-w-md">
        Challenge by <span><a href="https://www.frontendmentor.io?ref=challenge" className="text-black border-orange-500 hover:bg-orange-700">Frontend Mentor.</a></span>
        <p className="mt-2">
          Coded by <span><a href="https://backendfrontflip.github.io/spacecadetio/Socials/socials.html?fbclid=PAZXh0bgNhZW0CMTEAAabFp9fEE_4fLr7EkFU_A5yVvNfuzEC3uf6EDpOGaX00M3Lfiur2U9GGGxI_aem_B8FgTY0lbmdS6kxU0xSgGw" className="text-black border-orange-500 hover:bg-orange-700">Space Cadet.</a></span>
        </p>
      </div>
    </div>
  );
